$(function(){
	...
	if (($.inArray(0,settings.posts_or_pms) && pb.data('route').name == 'thread') || ($.inArray(1,settings.posts_or_pms) && pb.data('route').name == 'conversation')) {$('div.message:not(.ui-resizable)').each(function(){
